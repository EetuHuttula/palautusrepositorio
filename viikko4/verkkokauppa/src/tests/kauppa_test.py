...
class TestKauppa(unittest.TestCase):
    ...
    def test_aloita_asiointi_nollaa_aiemman_ostoksen_tiedot(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kahden_eri_tuotteen_osto_kutsutaan_pankki_oikealla_summalla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kahden_saman_tuotteen_osto_kutsutaan_pankki_oikealla_summalla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tuote_loppu_ei_vaikuta_summaan(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_korista_poistettu_tuote_ei_vaikuta_summaan(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
